...
def llama3_inv_freq(inv_freq):
    factor = 8.0  # `8` in the original implementation
    low_freq_factor = 1.0  # `1` in the original implementation
    high_freq_factor = 4.0 # `4` in the original implementation
...
class ChunkLlamaRotaryEmbedding(nn.Module):
    ...
    def _set_cos_sin_cache(self, seq_len, device, dtype):
        ...
        inv_freq = llama3_inv_freq(inv_freq)
...
linear_factor = None
MAX_NEW_TOKENS = 1300
MAX_CACHE_LEN = 128 * 1024 + MAX_NEW_TOKENS # default max_len
...
def replace_with_chunkllama(pretraining_length=4096, local_window_size=None, max_prompt_length=None):
    ...
    transformers.models.qwen2.modeling_qwen2.Qwen2Model.forward = LlamaModel_forward
    ...
    transformers.models.qwen2.modeling_qwen2.Qwen2LinearScalingRotaryEmbedding = ChunkLlamaRotaryEmbedding
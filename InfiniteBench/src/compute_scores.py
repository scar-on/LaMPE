...
DEFAULT_ROUGE_PATH = Path(__file__).resolve().parents[1] / "evaluate" / "metrics" / "rouge" / "rouge.py"
ROUGE_SCORER = evaluate.load(str(DEFAULT_ROUGE_PATH) if DEFAULT_ROUGE_PATH.exists() else "rouge")
